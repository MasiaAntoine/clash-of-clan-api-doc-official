# Lister les saisons d'une ligue

| Propriété | Valeur |
|-----------|--------|
| **Méthode** | `GET` |
| **Chemin** | `/leagues/{leagueId}/seasons` |
| **Catégorie** | Ligues |

## Description

Saisons d'une ligue. Disponible uniquement pour la Ligue Légende.
