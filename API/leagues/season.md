# Obtenir le classement d'une saison de ligue

| Propriété | Valeur |
|-----------|--------|
| **Méthode** | `GET` |
| **Chemin** | `/leagues/{leagueId}/seasons/{seasonId}` |
| **Catégorie** | Ligues |

## Description

Classement d'une saison de ligue. Disponible uniquement pour la Ligue Légende.
...
| `seasonId` | `string` | path | Oui | Identifier of the season. |
